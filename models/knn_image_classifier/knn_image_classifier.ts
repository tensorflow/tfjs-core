...
// import {Array1D, Array2D, Array3D, Model, NDArrayMath, NDArrayMathCPU} from
// 'deeplearn'; import {SqueezeNet} from '../squeezenet/squeezenet';
...
//         this.classLogitsMatrices[classIndex] = imageLogits.as2D(1,
//         logitsSize);
//       } else {
...
//    * @returns A dict of the top class for the image and an array of
//    confidence
...
//       // Lazily create the logits matrix for all training images if
//       necessary. if (this.trainLogitsMatrix == null) {
...
//       const knn = this.math
//                       .matMul(
//                           this.trainLogitsMatrix.as2D(numExamples,
//                           logitsSize), imageLogits.as2D(logitsSize, 1))
//                       .as1D();
//       // mathCPU downloads the values, so we should wait until the GPU is
//       done
