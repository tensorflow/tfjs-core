...
npm-run-all -p -c --aggregate-output \
  ...
  "test-travis --browsers=bs_ios_11 --features '{\"WEBGL_CPU_FORWARD\": false}' --backend webgl" \
  ...
  "test-travis --browsers=bs_chrome_mac --features '{\"WEBGL_CPU_FORWARD\": true}' --backend webgl"
