...
npm-run-all -p -c --aggregate-output \
  ...
  "run-browserstack --browsers=bs_ios_12 --backend webgl --flags '{\"WEBGL_CPU_FORWARD\": false, \"WEBGL_SIZE_UPLOAD_UNIFORM\": 0}'" \
  "run-browserstack --browsers=bs_ios_12 --flags '{\"HAS_WEBGL\": false}' --backend cpu" \
