...
export declare function assertArgIsTensor<T extends Tensor>(x: T | TensorLike, argName: string, functionName: string, dtype?: DataType): T;
export declare function assertArgIsTensorArr<T extends Tensor>(arg: T[] | TensorLike[], argName: string, functionName: string): T[];
export declare function assertArgumentsAreTensors<T extends Tensor>(args: {
    [argName: string]: T | TensorLike;
