...
var LSTMOps = (function () {
    ...
    LSTMOps.multiRNNCell = function (lstmCells, data, c, h) {
        var $data = util.assertArgIsTensor(data, 'data', 'multiRNNCell');
        var $c = util.assertArgIsTensorArr(c, 'c', 'multiRNNCell');
        var $h = util.assertArgIsTensorArr(h, 'h', 'multiRNNCell');
        var input = $data;
        var newStates = [];
