...
var LossOps = (function () {
    ...
    LossOps.computeWeightedLoss = function (losses, weights, reduction) {
        ...
        var $losses = util.assertArgIsTensor(losses, 'losses', 'computeWeightedLoss');
        var $weights = null;
        if (weights != null) {
            $weights =
    ...
    LossOps.absoluteDifference = function (labels, predictions, weights, reduction) {
        if (reduction === void 0) { reduction = Reduction.SUM_BY_NONZERO_WEIGHTS; }
        var $labels = util.assertArgIsTensor(labels, 'labels', 'absoluteDifference');
        var $predictions = util.assertArgIsTensor(predictions, 'predictions', 'absoluteDifference');
        var $weights = null;
        if (weights != null) {
            $weights =
    ...
    LossOps.meanSquaredError = function (labels, predictions, weights, reduction) {
        if (reduction === void 0) { reduction = Reduction.SUM_BY_NONZERO_WEIGHTS; }
        var $labels = util.assertArgIsTensor(labels, 'labels', 'meanSquaredError');
        var $predictions = util.assertArgIsTensor(predictions, 'predictions', 'meanSquaredError');
        var $weights = null;
        if (weights != null) {
    ...
    LossOps.cosineDistance = function (labels, predictions, axis, weights, reduction) {
        if (reduction === void 0) { reduction = Reduction.SUM_BY_NONZERO_WEIGHTS; }
        var $labels = util.assertArgIsTensor(labels, 'labels', 'cosineDistance');
        var $predictions = util.assertArgIsTensor(predictions, 'predictions', 'cosineDistance');
        var $weights = null;
        if (weights != null) {
    ...
    LossOps.hingeLoss = function (labels, predictions, weights, reduction) {
        if (reduction === void 0) { reduction = Reduction.SUM_BY_NONZERO_WEIGHTS; }
        var $labels = util.assertArgIsTensor(labels, 'labels', 'hingeLoss');
        var $predictions = util.assertArgIsTensor(predictions, 'predictions', 'hingeLoss');
        var $weights = null;
        if (weights != null) {
    ...
    LossOps.logLoss = function (labels, predictions, weights, epsilon, reduction) {
        ...
        if (reduction === void 0) { reduction = Reduction.SUM_BY_NONZERO_WEIGHTS; }
        var $labels = util.assertArgIsTensor(labels, 'labels', 'logLoss');
        var $predictions = util.assertArgIsTensor(predictions, 'predictions', 'logLoss');
        var $weights = null;
        if (weights != null) {
    ...
    LossOps.huberLoss = function (labels, predictions, weights, delta, reduction) {
        ...
        if (reduction === void 0) { reduction = Reduction.SUM_BY_NONZERO_WEIGHTS; }
        var $labels = util.assertArgIsTensor(labels, 'labels', 'huberLoss');
        var $predictions = util.assertArgIsTensor(predictions, 'predictions', 'huberLoss');
        var $weights = null;
        if (weights != null) {
