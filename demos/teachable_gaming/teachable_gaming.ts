...
// '../../models/knn_image_classifier/knn_image_classifier'; import
// {PolymerElement, PolymerHTMLElement} from '../polymer-spec';
...
//     this.toggles = [
//       this.$.upswitch, this.$.downswitch, this.$.leftswitch,
...
// document.registerElement(TeachableGamingDemo.prototype.is,
// TeachableGamingDemo);
