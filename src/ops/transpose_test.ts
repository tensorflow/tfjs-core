...
describeWithFlags('transpose', ALL_ENVS, () => {
  ...
  it('5D [r, c, d, e, f] => [r, c, d, f, e]', () => {
    const t = tf.tensor5d(
        [
          1,   11,   2,    22,    3,    33,    4,    44,    10,   110,  20,
          220, 30,   330,  40,    440,  100,   1100, 200,   2200, 300,  3300,
          400, 4400, 1000, 11000, 2000, 22000, 3000, 33000, 4000, 44000
        ],
        [2, 2, 2, 2, 2]);
    ...
    expectArraysClose(t2, [
      1,    2,    11,   22,   3,     4,     33,   44,   10,    20,   110,
      220,  30,   40,   330,  440,   100,   200,  1100, 2200,  300,  400,
      3300, 4400, 1000, 2000, 11000, 22000, 3000, 4000, 33000, 44000
    ]);
  });
  ...
  it('5D [r, c, d, e, f] => [c, r, d, e, f]', () => {
    ...
    expect(t2.shape).toEqual([2, 2, 2, 2, 2]);
    expectArraysClose(t2, [
      1,    11,  2,    22,    3,    33,    4,    44,    100,  1100, 200,
      2200, 300, 3300, 400,   4400, 10,    110,  20,    220,  30,   330,
      40,   440, 1000, 11000, 2000, 22000, 3000, 33000, 4000, 44000
    ]);
  });
