...
describeWithFlags('batchNormalization2D', ALL_ENVS, () => {
  ...
  it('throws error when x is a string tensor', () => {
    ...
    expect(f).toThrowError(
        /Argument \'x\' passed to \'batchNormalization\' must be a numeric/);
  });
  ...
  it('throws error when mean is a string tensor', () => {
    ...
    expect(f).toThrowError(
        /Argument \'mean\' passed to \'batchNormalization\' must be a numeric/);
  });
  ...
  it('throws error when variance is a string tensor', () => {
    ...
    expect(f).toThrowError(
        /\'variance\' passed to \'batchNormalization\' must be a numeric/);
  });
  ...
  it('throws error when scale is a string tensor', () => {
    ...
    expect(f).toThrowError(
        /\'scale\' passed to \'batchNormalization\' must be a numeric/);
  });
  ...
  it('throws error when offset is a string tensor', () => {
    ...
    expect(f).toThrowError(
        /\'offset\' passed to \'batchNormalization\' must be a numeric/);
  });
});
