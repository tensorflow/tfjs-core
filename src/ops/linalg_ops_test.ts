...
describeWithFlags('qr', ALL_ENVS, () => {
  ...
  //   expectArraysClose(r, tensor2d([[-2.2361, -4.9193], [0, -0.8944]],
  //   [2,
  //   2]));
  // });

  // it('2x2x2', () => {
  //   const x = tensor3d([[[-1, -3], [2, 4]], [[1, 3], [-2, -4]]], [2, 2,
  //   2]);
  //   const [q, r] = tf.linalg.qr(x);
  //   expectArraysClose(
  //       q,
  ...
  //       r,
  //       tensor2d(
  //           [[-8.3066, 8.3066, -2.4077], [0, 4.5826, -2.1822], [0,
  //           0, 7.6447]], [3, 3]));
  // });
  ...
  //   const x = tensor2d([[1, 3], [-2, -4]], [2, 2]);
  //   // The first call to qr creates and keeps internal singleton
  //   tensors.
  ...
  // //   const x = tensor2d([[1, 2, 3], [-3, -2, 1]], [2, 3]);
  // //   expect(() => tf.linalg.qr(x)).toThrowError(/requires.*shape/);
  // // });

  // it('Insuffient input tensor rank leads to error', () => {
  //   const x1 = scalar(12);
  //   expect(() => tf.linalg.qr(x1)).toThrowError(/rank >= 2.*got rank
  //   0/);
  //   const x2 = tensor1d([12]);
  //   expect(() => tf.linalg.qr(x2)).toThrowError(/rank >= 2.*got rank
  //   1/);
  // });
});
