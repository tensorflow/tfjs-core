...
import {assert, assertNonNull, assertPositiveIntegerDimensions, flatten, getArrayFromDType, inferDtype, isTypedArray, makeOnesTypedArray, makeZerosTypedArray, sizeFromShape, toTypedArray} from '../util';
...
function tensor<R extends Rank>(
  ...
  if (shape != null) {
    assertPositiveIntegerDimensions(shape);
