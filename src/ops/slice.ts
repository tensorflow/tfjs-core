...
export class SliceOps {
   ...
   *     array should match the rank of `x`. Can also be a single number, in
   *     which case it specifies first axis.
   * @param size The size of the slice. The length of this array should match
   *     the rank of `x`. A value of -1 requests the rest of the dimensions in
   *     the axis.
   */
