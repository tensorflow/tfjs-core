...
describeWithFlags('mulmat_packed_gpu (1x1 * 1x1)', DOWNLOAD_FLOAT_ENVS, () => {
...
describeWithFlags(
    'mulmat_packed_gpu (dot product)', DOWNLOAD_FLOAT_ENVS, () => {
      it('returns a 1x1 matrix', () => {
...
describeWithFlags('mulmat_packed_gpu (2x2 * 2x2)', DOWNLOAD_FLOAT_ENVS, () => {
...
describeWithFlags(
    'mulmat_packed_gpu (different shapes)', DOWNLOAD_FLOAT_ENVS, () => {
      ...
      it('multiplies A (2x4) by B(4x3)', () => {
        const a =
            new Float32Array([0.1, 3.2, -4.5, 11.78, -0.234, -2.999, 7, 9]);
...
describeWithFlags(
    'mulmat_packed_gpu (large matrices)', DOWNLOAD_FLOAT_ENVS, () => {
...
describeWithFlags(
    'mulmat_packed_gpu (multiple matrices)', DOWNLOAD_FLOAT_ENVS, () => {
...
describeWithFlags('mulmat_packed_gpu A * B^t', DOWNLOAD_FLOAT_ENVS, () => {
  it('1x1 * 1x1', () => {
...
describeWithFlags(
    'mulmat_packed_gpu (transposed versions)', DOWNLOAD_FLOAT_ENVS, () => {
      it('A * B^t', () => {
