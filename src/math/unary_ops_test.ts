...
describeWithFlags('relu', ALL_ENVS, () => {
  ...
  it('gradients: array', () => {
    ...
    expect(gradients.shape).toEqual(a.shape);
    expect(gradients.dtype).toEqual('float32');
    expectArraysClose(gradients, [1, 0, 0, 4]);
  });
});
...
describeWithFlags('abs', ALL_ENVS, () => {
  ...
  it('gradients: Scalar', () => {
    ...
    expect(gradients.shape).toEqual(a.shape);
    expect(gradients.dtype).toEqual('float32');
    expectArraysClose(gradients, [8 * 1], 1e-1);
  });
  ...
  it('gradients: Tensor1D', () => {
    ...
    expect(gradients.shape).toEqual(a.shape);
    expect(gradients.dtype).toEqual('float32');
    expectArraysClose(gradients, [1 * 1, 2 * 1, 3 * -1, 4 * 1], 1e-1);
  });
...
describeWithFlags('step', ALL_ENVS, () => {
  ...
  it('gradients: Scalar', () => {
    ...
    const gradients = dl.vjp(() => dl.step(a, 0.1), a, dy);
  ...
  it('gradients: Tensor1D', () => {
    ...
    const gradients = dl.vjp(() => dl.step(a), a, dy);
...
describeWithFlags('sqrt', ALL_ENVS, () => {
  ...
  it('gradients: Scalar', () => {
    ...
    expect(gradients.shape).toEqual(a.shape);
    expect(gradients.dtype).toEqual('float32');
    expectArraysClose(gradients, [8 / (2 * Math.sqrt(4))], 1e-1);
  });
...
describeWithFlags('ceil', ALL_ENVS, () => {
  ...
  it('gradients: Scalar', () => {
    ...
    const gradients = dl.vjp(() => dl.ceil(a), a, dy);
...
describeWithFlags('floor', ALL_ENVS, () => {
  ...
  it('gradients: Tensor1D', () => {
    ...
    const gradients = dl.vjp(() => dl.floor(a), a, dy);
