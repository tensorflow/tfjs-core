...
describe('tensor.toString', () => {
  it('scalar verbose', () => {
    const verbose = true;
    const str = dl.scalar(5).toString(verbose);
    expect(str).toEqual(
        'Tensor\n' +
        '  dtype: float32\n' +
        '  rank: 0\n' +
  ...
  it('1d tensor verbose', () => {
    const verbose = true;
    const str = dl.zeros([4]).toString(verbose);
    expect(str).toEqual(
        'Tensor\n' +
        '  dtype: float32\n' +
        '  rank: 1\n' +
  ...
  it('2d tensor verbose', () => {
    const verbose = true;
    const str = dl.zeros([3, 3]).toString(verbose);
    expect(str).toEqual(
        'Tensor\n' +
        '  dtype: float32\n' +
        '  rank: 2\n' +
  ...
  it('3d tensor verbose', () => {
    const verbose = true;
    const str = dl.zeros([3, 3, 2]).toString(verbose);
    expect(str).toEqual(
        'Tensor\n' +
        '  dtype: float32\n' +
        '  rank: 3\n' +
  ...
  it('1d long tensor verbose', () => {
    const verbose = true;
    const str = dl.zeros([100]).toString(verbose);
    expect(str).toEqual(
        'Tensor\n' +
        '  dtype: float32\n' +
        '  rank: 1\n' +
  ...
  it('2d long tensor verbose', () => {
    const verbose = true;
    const str = dl.zeros([100, 100]).toString(verbose);
    expect(str).toEqual(
        'Tensor\n' +
        '  dtype: float32\n' +
        '  rank: 2\n' +
